              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white/[0.02] p-8 md:p-10 rounded-[2rem] border border-white/5 backdrop-blur-md flex flex-col items-center justify-center text-center shadow-2xl transition-transform hover:-translate-y-1 duration-500">
                      ...
                      <div className="flex flex-wrap justify-center gap-4">
                          <a href={`${process.env.PUBLIC_URL}/resume.docx`} download="/resume.docx" className="bg-white text-black hover:bg-gray-200 font-semibold py-3 px-6 rounded-full transition-all transform hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.1)]">Download DOCX</a>
                          <a href={`${process.env.PUBLIC_URL}/resume.pdf`} download="/resume.pdf" className="bg-white/5 border border-white/10 hover:bg-white/10 text-white font-semibold py-3 px-6 rounded-full transition-all transform hover:scale-105">Download PDF</a>
                      </div>
                  </div>
